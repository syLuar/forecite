...
class DraftingState(TypedDict):
    ...
    party_represented: NotRequired[
        str
    ]  # Which party the user represents (e.g., "Plaintiff", "Defendant")
    ...
    proposed_strategy: NotRequired[
        Dict[str, Any]
    ]  # Frontend compatibility - structured strategy with key_arguments
